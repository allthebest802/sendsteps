/* =========================================================================
   Token Board — wrapper module.

   Your original app is UNCHANGED and lives in token-board.app.html (only its own
...
export function mount(el) {
  ...
  frame.src = '/app/tools/token-board.app.html';
  frame.title = 'Token Board';
  frame.style.cssText =

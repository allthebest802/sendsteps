/* =========================================================================
   Now & Next — wrapper module.

   Your original app is UNCHANGED and lives in now-next.app.html (only its own
...
export function mount(el) {
  ...
  frame.src = '/app/tools/now-next.app.html';
  frame.title = 'Now & Next board';
  frame.style.cssText =

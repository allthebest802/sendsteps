/* =========================================================================
   Communication Cards — wrapper module.

   Your original app is UNCHANGED and lives in comm-cards.app.html (only its own
...
export function mount(el) {
  ...
  frame.src = '/app/tools/comm-cards.app.html';
  frame.title = 'Communication Cards';
  frame.style.cssText =

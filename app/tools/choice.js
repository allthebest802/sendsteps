/* =========================================================================
   Choice Board — wrapper module.

   Your original app is UNCHANGED and lives in choice.app.html (only its own
...
export function mount(el) {
  ...
  frame.src = '/app/tools/choice.app.html';
  frame.title = 'Choice Board';
  frame.style.cssText =
